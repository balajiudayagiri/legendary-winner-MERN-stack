    ...
    validateinputfills = (data) => {
        if (!data.email) {
            this.setState({
                ...
                mailBoxErrorStyle: { border: '1px solid red', backgroundColor: '#e7aeae99', color: 'white' }
            })
        ...
        if (!data.password) {
            this.setState({
                ...
                passwordBoxErrorStyle: { border: '1px solid red', backgroundColor: '#e7aeae99', color: 'white' }
            })
